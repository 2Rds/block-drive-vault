-- Final security enhancement: Restrict regular user access to auth_tokens (Fixed order)

-- Create function to check auth token rate limiting FIRST
...
-- Update the validation function to be more restrictive
...
-- NOW drop the existing user policy and create the more restrictive one
