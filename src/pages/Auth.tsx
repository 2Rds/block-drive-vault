      ...
      <header className="border-b border-border bg-card/80 backdrop-blur-sm">
        <div className="flex items-center justify-between px-8 py-4">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-br from-primary to-accent p-2">
              <img src="/lovable-uploads/566ba4bc-c9e0-45e2-89fc-48df825abc4f.png" alt="BlockDrive Logo" className="w-full h-full object-contain" />
            </div>
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">BlockDrive</h1>
          ...
          <div className="space-y-6">
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="flex items-center justify-center p-3 bg-gradient-to-br from-primary/20 to-accent/20 rounded-lg border border-primary/30 backdrop-blur-sm">
                  <Database className="w-5 h-5 text-primary mr-2" />
                  <span className="text-primary text-sm font-medium">Decentralized Storage</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-gradient-to-br from-accent/20 to-primary/20 rounded-lg border border-accent/30 backdrop-blur-sm">
                  <Globe className="w-5 h-5 text-accent mr-2" />
                  <span className="text-accent text-sm font-medium">Multi-Chain Support</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-500/30 backdrop-blur-sm">
                  <Zap className="w-5 h-5 text-purple-300 mr-2" />
                  <span className="text-purple-300 text-sm font-medium">Lightning Fast</span>
                </div>
              </div>
            </div>
            ...
            {!dynamicReady && !sdkError && (
              <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/30 rounded-xl p-4 backdrop-blur-sm">
            ...
            {sdkError && (
              <div className="bg-gradient-to-r from-destructive/10 to-red-500/10 border border-destructive/30 rounded-xl p-4 backdrop-blur-sm">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <button 
                      onClick={handleRetry} 
                      className="flex items-center space-x-2 bg-gradient-to-r from-destructive to-red-500 hover:from-destructive/80 hover:to-red-500/80 text-destructive-foreground px-3 py-1.5 rounded text-sm transition-all duration-200"
                    >
            ...
            <div className="bg-gradient-to-br from-card/60 to-purple-900/20 border border-border rounded-xl p-6 backdrop-blur-sm">
              <h4 className="font-semibold text-card-foreground mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Enterprise-Grade Security</h4>
