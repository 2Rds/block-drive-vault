...
export const SecurityHeaders = () => {
  useEffect(() => {
    ...
    if (!document.querySelector('meta[http-equiv="Content-Security-Policy"]')) {
      ...
      meta.content = `
        default-src 'self';
        script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.supabase.co https://widget.intercom.io https://cdn.gpteng.co https://challenges.cloudflare.com https://*.dynamicauth.com https://app.dynamicauth.com https://*.dynamic.xyz https://*.coinbase.com https://cca-lite.coinbase.com https://*.walletlink.org;
